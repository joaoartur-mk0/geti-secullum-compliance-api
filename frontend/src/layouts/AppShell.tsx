...
const navItems = [
  ...
  { to: '/historico', label: 'Histórico', icon: ClipboardList, end: false, superAdminOnly: false },
  { to: '/ranking', label: 'Ranking', icon: Trophy, end: false, superAdminOnly: false },
  { to: '/revisao-mensal', label: 'Revisão mensal', icon: CalendarCheck, end: false, superAdminOnly: false },
  { to: '/investigar', label: 'Investigar', icon: Search, end: false, superAdminOnly: false },
