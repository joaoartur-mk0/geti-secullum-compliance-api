...
// Histórico de varreduras, que mostra só a mais recente). Aqui dá para ver, e pesquisar por
// data, cada varredura já rodada — inclusive reauditorias do mesmo dia. Página de
// configurações, mantida para registro/consulta, sem os controles de disparo.
...
export default function LogsHistorico() {
  ...
  return (
    <div className="animate-rise">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Logs/Histórico do sistema</h1>
