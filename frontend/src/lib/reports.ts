...
// dedupeByDay mantém, para cada dia auditado, só a varredura MAIS RECENTE — é o que o
// Painel usa para mostrar "1 auditoria por dia, sempre a mais atual", em vez do log
// inteiro (ver página Auditorias para o histórico completo).
//
